...
if __name__ == '__main__':
    path = r'C:\Users\lazar\Workspace\Yeaz\YeaZ_GUI\unet\unet_weights_BF_batchsize_25_Nepochs_100_SJR_0_1.hdf5'
    pt_model = weight_loading(path)
    # save the model
    torch.save(pt_model.state_dict(), 'bf_pt_model.pth')
    # print(pt_model)