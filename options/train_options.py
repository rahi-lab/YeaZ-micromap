...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # add grid search lambdas
        parser.add_argument('--grid_lambdas_A', nargs='+', type=float, default=[10.0], help='grid loss weight for cycle loss A')
        parser.add_argument('--grid_lambdas_B', nargs='+', type=float, default=[10.0], help='grid loss weight for cycle loss B')
